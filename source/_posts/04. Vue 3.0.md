...
mathjax: false
password:
summary: 前端正处于春秋战国时代，各路英雄豪杰成为后浪，新的轮子层出不穷，作为一个出道不到两年半的小喽啰还是希望咱们大前端的技术栈能像 Jave + Spring Boot 一样稳如老狗 (ಥ﹏ಥ)
tags:
- Vue
- JavaScript
categories:
...
到此为止关于`Vue3.0`核心的所有内容就暂时的谢幕了，内容还是相当多的，在这引用德华的歌——如果想要飞得高，就该把 Vue 2.0 忘掉 ~ 希望对大家有所帮助！