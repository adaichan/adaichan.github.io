...
mathjax: false
password:
summary: 本文是一篇记录该小站在2020年12月4日呱呱坠地的初步搭建指南，希望能帮到想建站的小伙伴 ♪♪
tags:
- GitHub
categories:
- 工具
...
如今知识分享的平台论坛五花八门，比如知乎、掘金、Stack Overflow、CSDN、博客园、思否还有简书等等，很多问题上面都有答案并且**方便收藏**，然鹅它们不够**个性化**，作为一个喜欢折腾的边缘人思量一番撅腚再弄个自己的無名小站，兜兜转转最后还是选择了 Hexo + [hexo-theme-matery](https://github.com/blinkfox/hexo-theme-matery) 这套架子来搭建。
